...
exports.updateCategory = exports.createCategory = exports.getCategoriesByPackageId = exports.getCategories = void 0;
...
exports.createCategory = (0, express_async_handler_1.default)(async (req, res) => {
    ...
    const data = req.body;
    const result = await (0, categoryUseCase_1.createCategoryUseCase)(data);
    res.status(200).json({
        success: true,
...
exports.updateCategory = (0, express_async_handler_1.default)(async (req, res) => {
    ...
    const data = req.body;
    const result = await (0, categoryUseCase_1.updateCategoryUseCase)(id, data);
    res.status(200).json({
        success: true,
