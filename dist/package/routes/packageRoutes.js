...
router.get('/allAdmin', authentication_1.authenticateAdmin, packageController_1.getAllPackagesAdmin);
...
router.get('/:id', authentication_1.authenticateAdmin, packageRequest_1.packageUpdateValidation, packageController_1.getPackagesById);
