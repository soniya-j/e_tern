...
exports.updateSubCategory = exports.createSubCategory = exports.getSubCategoriesByCategoryId = exports.getSubCategories = void 0;
...
exports.createSubCategory = (0, express_async_handler_1.default)(async (req, res) => {
    ...
    const data = req.body;
    const result = await (0, subCategoryUseCase_1.createSubCategoryUseCase)(data);
    res.status(200).json({
        success: true,
...
exports.updateSubCategory = (0, express_async_handler_1.default)(async (req, res) => {
    ...
    const data = req.body;
    const result = await (0, subCategoryUseCase_1.updateSubCategoryUseCase)(id, data);
    res.status(200).json({
        success: true,
